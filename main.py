...
def ydl_opts(url, download=False):
    ...
    # Deno is installed by the Dockerfile and is enabled automatically
    # by current yt-dlp when it is available on PATH.
    # Do NOT pass {"deno": None}; that causes a NoneType .get() error
    # in some yt-dlp versions.
